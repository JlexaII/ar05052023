document.addEventListener("DOMContentLoaded", function() {
    ...
    s.scope = {}, s.findInternal = function(t, a, e) { t instanceof String && (t = String(t)); for (var s = t.length, r = 0; r < s; r++) { var n = t[r]; if (a.call(e, n, r, t)) return { i: r, v: n } } return { i: -1, v: void 0 } }, s.ASSUME_ES5 = !1, s.ASSUME_NO_NATIVE_MAP = !1, s.ASSUME_NO_NATIVE_SET = !1, s.SIMPLE_FROUND_POLYFILL = !1, s.defineProperty = s.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(t, a, e) { t != Array.prototype && t != Object.prototype && (t[a] = e.value) }, s.getGlobal = function(t) { return "undefined" != typeof window && window === t ? t : "undefined" != typeof global && null != global ? global : t }, s.global = s.getGlobal(this), s.polyfill = function(t, a, e, r) {
    ...
    }, s.polyfill("Array.prototype.find", function(t) { return t || function(t, a) { return s.findInternal(this, t, a).v } }, "es6", "es3"), t = function(t) {
        var a = function(a, e, s) {
            var r = {
                ...
                events: function() { a.on("keydown.mask", function(t) { a.data("mask-keycode", t.keyCode || t.which), a.data("mask-previus-value", a.val()), a.data("mask-previus-caret-pos", r.getCaret()), r.maskDigitPosMapOld = r.maskDigitPosMap }).on(t.jMaskGlobals.useInput ? "input.mask" : "keyup.mask", r.behaviour).on("paste.mask drop.mask", function() { setTimeout(function() { a.keydown().keyup() }, 100) }).on("change.mask", function() { a.data("changed", !0) }).on("blur.mask", function() { o === r.val() || a.data("changed") || a.trigger("change"), a.data("changed", !1) }).on("blur.mask", function() { o = r.val() }).on("focus.mask", function(a) {!0 === s.selectOnFocus && t(a.target).select() }).on("focusout.mask", function() { s.clearIfNotMatch && !n.test(r.val()) && r.val("") }) },
                getRegexMask: function() { for (var t, a, s, r, n = [], o = 0; o < e.length; o++)(t = i.translation[e.charAt(o)]) ? (a = t.pattern.toString().replace(/.{1}$|^.{1}/g, ""), s = t.optional, (t = t.recursive) ? (n.push(e.charAt(o)), r = { digit: e.charAt(o), pattern: a }) : n.push(s || t ? a + "?" : a)) : n.push(e.charAt(o).replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&")); return n = n.join(""), r && (n = n.replace(new RegExp("(" + r.digit + "(.*" + r.digit + ")?)"), "($1)?").replace(new RegExp(r.digit, "g"), r.pattern)), new RegExp(n) },
                destroyEvents: function() { a.off("input keydown keyup paste drop blur focusout ".split(" ").join(".mask ")) },
                val: function(t) { var e = a.is("input") ? "val" : "text"; return 0 < arguments.length ? (a[e]() !== t && a[e](t), e = a) : e = a[e](), e },
                ...
                behaviour: function(e) {
                    ...
                    if (-1 === t.inArray(s, i.byPassKeys)) {
                        ...
                        return setTimeout(function() { r.setCaret(r.calculateCaretPosition(o)) }, t.jMaskGlobals.keyStrokeCompensation), r.val(s), r.setCaret(n), r.callbacks(e)
                    }
                },
                getMasked: function(t, a) {
                    ...
                    if (a = [], s.reverse) {
                        ...
                        var v = 0;
                        c = p - 1, d = u - 1;
                        var _ = function() { return -1 < c && -1 < d }
                    } else v = p - 1, _ = function() { return c < p && d < u };
                    for (; _();) {
                        var h = e.charAt(c),
                            g = l.charAt(d),
                            y = i.translation[h];
                        y ? (g.match(y.pattern) ? (o[k](g), y.recursive && (-1 === b ? b = c : c === v && c !== b && (c = b - m), v === b && (c -= m)), c += m) : g === n ? (f--, n = void 0) : y.optional ? (c += m, d -= m) : y.fallback ? (o[k](y.fallback), c += m, d -= m) : r.invalid.push({ p: d, v: g, e: y.pattern }), d += m) : (t || o[k](h), g === h ? (a.push(d), d += m) : (n = h, a.push(d + f), f++), c += m)
                    }
                    return t = e.charAt(v), p !== u + 1 || i.translation[t] || o.push(t), o = o.join(""), r.mapMaskdigitPositions(o, a, u), o
                },
                mapMaskdigitPositions: function(t, a, e) { for (t = s.reverse ? t.length - e : 0, r.maskDigitPosMap = {}, e = 0; e < a.length; e++) r.maskDigitPosMap[a[e] + t] = 1 },
                callbacks: function(t) {
                    var n = r.val(),
                        i = n !== o,
                        l = [n, t, a, s],
                        c = function(t, a, e) { "function" == typeof s[t] && a && s[t].apply(this, e) };
            ...
            var n, i = this,
                o = r.val();
            e = "function" == typeof e ? e(r.val(), void 0, a, s) : e, i.mask = e, i.options = s, i.remove = function() { var t = r.getCaret(); return i.options.placeholder && a.removeAttr("placeholder"), a.data("mask-maxlength") && a.removeAttr("maxlength"), r.destroyEvents(), r.val(i.getCleanVal()), r.setCaret(t), a }, i.getCleanVal = function() { return r.getMasked(!0) }, i.getMaskedVal = function(t) { return r.getMasked(!1, t) }, i.init = function(o) {
                if (o = o || !1, s = s || {}, i.clearIfNotMatch = t.jMaskGlobals.clearIfNotMatch, i.byPassKeys = t.jMaskGlobals.byPassKeys, i.translation = t.extend({}, t.jMaskGlobals.translation, s.translation), i = t.extend(!0, {}, i, s), n = r.getRegexMask(), o) r.events(), r.val(r.getMasked());
                    ...
                    for (var l = !0; o < e.length; o++) { var c = i.translation[e.charAt(o)]; if (c && c.recursive) { l = !1; break } }
        ...
        var e = function() {
            ...
            s = function(a, e, s) {
                ...
                var r = t(a).data("mask"),
                    n = JSON.stringify;
                a = t(a).val() || t(a).text();
                try { return "function" == typeof e && (e = e(a)), "object" != typeof r || n(r.options) !== n(s) || r.mask !== e } catch (t) {}
            },
            r = function(t) {
        ...
        t.fn.mask = function(e, r) {
            ...
            var l = function() { if (s(this, e, r)) return t(this).data("mask", new a(this, e, r)) };
            return t(this).each(l), n && "" !== n && i && (clearInterval(t.maskWatchers[n]), t.maskWatchers[n] = setInterval(function() { t(document).find(n).each(l) }, o)), this
    ...
    var t, a, e;
    t = jQuery, a = { productElement: "product__element", buttonAddToBasket: "product__add-to-cart-button", countryCode: "+", smartBasketCurrency: "₴", productQuantityWrapper: !1, productPrice: !1, productSize: !1, smartBasketMinArea: "header__basket-min", smartBasketMinIconPath: "/smartbasket/img/shopping-basket-wight.svg", smartBasketMinText: !1, telIsRequired: !0, emailIsRequired: !1, nameIsRequired: !0, localStorageName: "basketItems", yaCounter: { counterID: "", targetID: "" } }, e = {
        getProducts: function() { return JSON.parse(localStorage.getItem(a.localStorageName)) },
        setProducts: function(t) { let e = JSON.stringify(t, "", 4); return localStorage.setItem(a.localStorageName, e), !1 },
        ...
        showProducts: function(s) {
            let r = t("<form>").attr({ class: "smart-basket__form", method: "POST", id: "smart-basket__form", enctype: "multipart/form-data" }),
                ...
                i = t("<div>").attr({ class: "smart-basket__product-id" }).text("Артикул"),
            ...
            c.click(() => { d.fadeToggle() }), p.click(t => { t.preventDefault(), d.fadeToggle() });
            ...
            for (let n in s) {
                let i = t("<div>").attr({ class: "smart-basket__product-item" }),
                    ...
                    u1 = t("<input>").attr({ class: "smart-basket__input", type: "hidden" }),
        ...
        stateBasket: function() {
            ...
            return e.getSmartBasketMinState(o), c.click(function() {
                ...
                if (void 0 !== r[n]) { let a = t(this).html(); return t(this).text("Товар уже в корзине"), t("body").append(e.alertBlock("alreadyAdded")), setTimeout(() => { t(this).html(a) }, 1500), !1 } {
                    let i = {};
        ...
        commonResult: function(e, s, r) {
            ...
            if (0 == +n ? o.fadeIn() : o.fadeOut(), r) t("." + l.attr("class")).css("display", "block"), setTimeout(() => { t("." + l.attr("class")).css("display", "none"), t("." + o.attr("class")).css("display", "block") }, 3e3);
            else {
        ...
        getSmartBasketMinState: function(s, r) {
            ...
            let o = t("<img>").attr({ class: "smart-basket__min-icon", src: a.smartBasketMinIconPath, width: 25, alt: "Корзина" }),
        ...
        userForm: function() {
            ...
            let o = t("<div>").attr({ class: "smart-basket__input-wrapper" }),
                l = t("<input>").attr({ class: "smart-basket__user-input", type: "tel", placeholder: "Введите телефон", name: "userTel", required: a.telIsRequired }).mask(a.countryCode + "(00)000-00-00");
            o.append(l);
            ...
            let u1 = t("<a href='oplata.php' target='_blank'>").attr({ class: "smart-basket__pay-form", style: "text-decoration: none;" }).text("Оплатить мгновенно");
            ...
            r.append(n).append(o).append(c), a.agreement.isChecked && r.append(d), k.append(u).append(u1).append(m).append(m), s.append(r).append(k), m.click(function(t) {
                t.preventDefault();
                let s = e.getProducts() || {};

                function r(t) { for (let a in t) return !1; return !0 }
            ...
            let b = a => { a.focus(function() { t(this).parent().addClass("smart-basket__input-wrapper_focus") }), a.blur(function() { t(this).parent().removeClass("smart-basket__input-wrapper_focus"), "" === this.value && t(this).parent().addClass("smart-basket__input-wrapper_error") }), a.parent().on("input", function() { t(this).removeClass("smart-basket__input-wrapper_error") }), a.change(function() { t(this).parent().removeClass("smart-basket__input-wrapper_error"), t(this).parent().addClass("smart-basket__input-wrapper_focus") }) };
            return b(i), a.telIsRequired && b(l), a.emailIsRequired && b(p), s
        },
        getModalBasket: function(a, s) { e.commonResult(s, "updateCommonResult"), a.click(a => { a.preventDefault(), t(".smart-basket").toggleClass("smart-basket_active"), t("body").css("overflow", "hidden") }) },
        closeModalBasket(a) { a.click(a => { a.preventDefault(), t(".smart-basket").toggleClass("smart-basket_active"), t("body").css("overflow", "auto") }) },
        sendCart: function() {
            ...
            t.ajax({
                ...
                complete: function(s) {
                    ...
                    let r = e.getProducts() || {};
                    e.commonResult(r, "", "submitEvent"), localStorage.clear(), "" !== a.yaCounter.counterID && "" !== a.yaCounter.targetID && ym(a.yaCounter.counterID, "reachGoal", a.yaCounter.targetID), setTimeout(() => { t(".smart-basket").toggleClass("smart-basket_active"), t("body").css("overflow", "auto") }, 3e3), setTimeout(() => { r = e.getProducts() || {}, e.commonResult(r, "updateCommonResult"), e.getSmartBasketMinState(r, "updateSmartBasketMin"), e.showProducts(r) }, 4e3)
                }
            })
        },
        alertBlock: function(a) {
            ...
            l.click(function() { t(this).parents("." + s.attr("class")).remove() }), c.click(function() { t(this).parents("." + s.attr("class")).remove() });
            let p = e.getProducts() || {};
        ...
        init: function(s) { t.extend(a, s); return this.each(function() { t(this).append(e.stateBasket()) }) }
    }, t.fn.smbasket = function(a) { return e[a] ? e[a].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof a && a ? void t.error("Метод " + a + " не найден") : e.init.apply(this, arguments) }
});